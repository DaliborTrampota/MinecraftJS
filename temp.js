...
class Player {
  ...
  checkCollision(){
    ...
    if( boxesCollision ){
      ...
      // copy one of the last 5 positions, -5 is index 0, 
      // which is the same as last position
      this.body.position.copy( 
        this.prevPositions[this.prevPositions.length-5] 
      );
    }
  }
  ...
  updateMovement( time ){
    ...
    this.prevPositions.unshift( this.body.position.clone() );
